# Generated by Django 2.2.5 on 2020-06-22 07:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('main_tag_select', models.ForeignKey(blank=True, default=1, null=True, on_delete=django.db.models.deletion.CASCADE, to='Data_app.tag_data')),
            ],
        ),
        migrations.CreateModel(
            name='PostCreate',
            fields=[
                ...
                ('tag_creator', models.ManyToManyField(blank=True, null=True, to='Data_app.tag_createors')),
            ],
        ),
    ]
